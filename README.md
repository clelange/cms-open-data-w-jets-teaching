...
- [`truth_and_four_momentum_69747.ipynb`](notebooks/truth_and_four_momentum_69747.ipynb) is an advanced extension covering `LHEPart`, four-momentum conservation, generator-copy bookkeeping, and decay trees.
